...
// *  Addtion functions
// */
//+ (XMPPMessage *)chatMessageTo:(XMPPJID *)to time:(NSDate *)time private:(BOOL)private chatRoom:(BOOL)chatRoom;
//- (id)initWithTime:(NSDate *)time to:(XMPPJID *)to private:(BOOL)private chatRoom:(BOOL)chatRoom;
